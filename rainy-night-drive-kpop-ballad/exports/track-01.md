**기본프롬프트**
```text
Style: Nocturnal K-pop ambient ballad Feel: Rainy midnight drive; a radio voice softens solitude; steady low intensity Tempo/Groove: 88 BPM, 4/4; quarters | bass pickup to beat 1 | rim alternate bars Vocal: Japanese modern female jazz alto A3-D5, centered A3-C#5; clear English, stable tone, clean joins, small intervals, restrained vibrato Instrumentation: felt piano | two-note gaps | vocal bar 5; ambient synth, round bass, rim support Harmony: Bm; Verse Bm-Gmaj7-D/F#-A; Pre Em7-F#7-Bm-A/C#; Chorus Gmaj7-A-F#m7-Bm, Em7-A-Dmaj7-F#7; final G-A-D Form/Flow: 4-bar ambient entry; even density and low register; color-shift bridge; final return dissolves into rain; strong hook prominence Production/Mix: Centered low lead, narrow dynamics, long dark reverb, air, soft transients, stable lows
```

**절대불가프롬프트**
```text
swing, walking bass, jazz comping, brushes, horns, scat, drum crescendos, notes above D5, belting
```

### Voice Beyond the Wipers
