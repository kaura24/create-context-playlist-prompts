**기본프롬프트**
```text
Style: Rainy nocturnal K-pop ballad Feel: Slow rainy drive; returning a spare key becomes quiet separation Tempo/Groove: 76 BPM, 4/4; half notes | synth on beat 4 | full-bar drum gaps Vocal: Japanese modern female jazz alto A3-C5, mostly A3-B4; clear English, stable tone, clean joins, C5 ceiling, low phrases Instrumentation: low synth | single-note pulses | vocal bar 5; round bass, delayed sparse piano, rim support Harmony: Dm(add9); Verse Dm-C/E-Bbmaj7-F/A; Pre Gm7-Dm/F-Eb-Asus4-A; Chorus Bbmaj7-C-Am7-Dm, Gm7-Asus4-Dm; Refrain Bb-C-Dm-Dm/C; two-bar changes, descending bass, suspended cadences Form/Flow: Near-empty intro; half-bar vocal rests; one-bar air before choruses; drumless bridge; standalone refrain; bare outro; moderate hook prominence Production/Mix: Centered low lead, clean phrase gaps, intermittent ambience, short dark tails, centered lows, narrow dynamics, soft transients
```

**절대불가프롬프트**
```text
jazz backing, swing, walking bass, brushes, horns, scat, dense layers, nonstop drums, >C5, belting
```
